...
router.get("/:userId", getActivityController); // get by date 
router.get("/:userId/past-week", getPastWeekActivityController); // get past 7 days

// Monthly summary routes
router.post("/monthly/update", updateMonthlySummaryController); // update monthly summary 
router.get("/:userId/monthly/current", getCurrentMonthlySummaryController); // get current month summary
router.get("/:userId/monthly/:month", getMonthlySummaryController); // get specific month summary 
